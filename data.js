...
/* Waypoint v1.2 — data layer. Snapshot 2026-07-16.
   ...
   around Joël's real structure: ≈€90k crash-deployable dry powder + ≈€220k core
   ...
   MODULAR — ≈€90k powder + ≈€118k iBonds-2030 completion tranche ≈ €208k that can
   buy the NL home outright at ANY early-return date while a ≈€102k iBonds-2031
   ...
   v1.27 (2026-07-20): VISA folded into COL (backlog #4, research-11-visa-costs.md — 9-agent
   parallel research, 2025-26 official+expat sources, Dutch/EU passport). Each country carries
   `visa` = amortised €/mo for the CHEAPEST legal route (BLENDED convention: long-stay for
   anchor/home PH 40 / TH 26 DTV / GE 0, short-stay for pass-through live-countries VN 7 / IN 12
   / ID 28 / MY 5 / JP 0 / KH 28; CZ/SI 0 EU). His call: fold it straight into the COL total
   (a cost he can't escape), NOT a separate Match line — app.js visaOf() adds it into every
   displayed COL figure + place row; footnote notes it's included; ledger opens for line-by-line.
   Also `maxstay` per country → a "Max realistic stay" line on each card (his idea): the more
   decision-relevant output than the €/mo, which barely re-ranks anywhere. Standouts: KH indefinite
...
const DATA_STAMP='2026-07-29';
const ECB_STAMP={dfr:2.25,asOf:'2026-07-23',estr:2.19,note:'⚠ THIS IS A HIKING CYCLE. The ECB RAISED on 11 Jun 2026 (DFR 2.00 → 2.25, effective 17 Jun) — its first hike since Sep 2023, on the energy shock — then HELD unanimously on 23 Jul. €STR 2.186. Markets price DFR ≈2.70% by Dec 2026 and ≈2.78% by Feb 2027, 10 Sep nearly fully priced (Reuters poll: 52 of 74 expect a Sep hike). The Council pre-commits to nothing, but the DIRECTION is up. ⚠ AND IT IS ALREADY IN THE PRICE: the German 2y at 2.82% against a 2.25% deposit rate embeds ~55bp, and the 5y at 2.86% prices no further tightening — so a mid-2027 entry yield is expected to be roughly UNCHANGED, not higher. Verified 29 Jul 2026.'};
...
const MONITORS=[
  {dues:['2026-09-10','2026-10-29','2026-12-17','2027-02-04','2027-03-18','2027-04-29','2027-06-10','2027-07-22','2027-09-09','2027-10-28','2027-12-16'],t:'ECB decision — re-stamp the yield snapshots',
    d:'Re-stamped 29 Jul 2026 — AND THE DIRECTION WAS WRONG BEFORE. This is a HIKING cycle: the ECB raised on 11 Jun 2026 (DFR 2.00 → 2.25) and held on 23 Jul; markets price ≈2.70% by Dec 2026 and ≈2.78% by Feb 2027, 10 Sep nearly fully priced. The short end DID move this time, so the shelf WAS re-stamped: German 2y 2.71 → 2.82, iBonds-2029 3.30 → 3.37 gross, iBonds-2030 3.44 → 3.51, iBonds-2031 3.69 → 3.68 (iShares, 27 Jul). MMF / FRN / short-govt were NOT re-verified and keep their old stamps — a re-stamp means re-VERIFY, not re-DATE. 🎯 THE THING TO UNDERSTAND: those hikes are ALREADY PRICED. German 2y 2.82 against a 2.25 deposit rate embeds ~55bp; the 5y at 2.86 prices nothing further; the 1y-forward 4y is ≈2.89. So do NOT plan on a higher entry yield in mid-2027 — the forwards say roughly unchanged, and the downside (ECB cuts in 2027) is just as live. Use the Custom-yield row to see that branch. The real asymmetry is EUR IG CREDIT SPREADS: ~85-89bp, the 20th percentile of history, with the ECB FSR (May 2026) calling risk premia compressed globally — mean reversion alone is +25-45bp, a 2022-style repricing +145bp. ⇒ THE RULE: SPREADS SET THE MIX, NOT THE DATE. Next decision 10 Sep 2026 (Berlin). Path p4.'},
  ...
  {t:'TH remittance decree — monitor, never plan on it',
    d:'✅ RE-VERIFIED 27 Jul 2026 — STILL NOT ENACTED, no change to the leash. The relaxation (exempt if remitted in the year earned or the next) remains a DRAFT; the instrument would be a royal decree or ministerial regulation and it never cleared Cabinet/Council of State, having been shelved around the Dec 2025 dissolution + Feb 2026 election. The operative law is still the Jan-2024 remittance rule (Por.161/2566); income earned BEFORE 1 Jan 2024 stays permanently exempt on remittance (Por.162/2566). Until published law the no-remit leash is permanent; if enacted it also zeroes the ~3.5% tax on living remittances. 🆕 ADDED 29 Jul 2026 — THE COACHING INCOME, and it is a DIFFERENT question from the crypto. The remittance basis only shelters FOREIGN-source income. Under Revenue Code §41, income from work PERFORMED IN THAILAND is Thai-source whether or not it is paid or received there — so coaching delivered while physically sitting in TH is arguably Thai-source and NOT sheltered at all, no matter which foreign account the client pays into. Same shape in PH: NIRC §23 exempts foreign-source income of aliens, and services performed in PH are PH-source. This is the SAME physical-presence doctrine that Guardrail 9 (hub-click) exists to defeat for the sale — applied to earned income instead. The amounts are probably small enough to be a rate-and-filing question rather than a plan-breaker, but the business is now doing structural work as a post-2031 income hedge, so PRICE IT before leaning on it. Add to the mid-2027 TH re-verification checklist. Same check: the DORMANT Sep 2024 worldwide-income draft (never reached parliament) — a revival would make TH-resident SALE years dangerous. Re-verify both before committing to TH residency and again before any sale.'},
...
const INSTRUMENTS={
  ...
  govt:{name:'Short govt-bond ETF 1–3y',ref:'iShares IBGS · TER 0.20% · WAM 1.7y · gross YTM 2.68%',yld:2.48,stamp:'2026-06-22',
    ...
    powder:2},
  schatz:{name:'German 2y held to maturity',ref:'Bund Schatz · no wrapper, no TER',yld:2.82,stamp:'2026-07-24',
  ...
  ib29:{name:'iBonds Dec 2029 — fixed-maturity IG',ref:'iShares 29GI (dist, IE000IHURBR0) · TER 0.12% · gross YTW 3.37% · pays out cash ~1 Jan 2030',yld:3.25,stamp:'2026-07-27',
    ...
    hold:'UCITS ETF.',
    powder:4},
  ib30:{name:'iBonds Dec 2030 — fixed-maturity IG',ref:'iShares 30IG/30IA · TER 0.12% · gross YTW 3.51% · pays out cash ~1 Jan 2031',yld:3.39,stamp:'2026-07-27',star:'the apartment tranche',
    ...
    hold:'UCITS ETF.',
    powder:4},
  ib31:{name:'iBonds Dec 2031 — fixed-maturity IG',ref:'iShares 31IG (dist, IE000I2WYEU9) / IG31 (acc) · TER 0.12% · gross YTM 3.68% · pays out cash ~1 Jan 2032',yld:3.56,stamp:'2026-07-27',star:'the plan-end lock',
  ...
  dep:{name:'Term-deposit ladder — RETIRED',ref:'Raisin marketplace · 1y ≈2.99% / 2y ≈3.05% gross',yld:3.05,stamp:'2026-07-14',
    risk:'Bank credit, capped by the €100k/person/bank guarantee → €310k must split across 4+ banks.',
...
const COUNTRIES=[
  {cc:'PH',n:'Philippines',f:'🇵🇭',roles:['anchor','live'],stamp:'2026-07-19',primary:true,visa:40,maxstay:'36 months continuous — no border runs needed',
    col:{f:744,n:1250,city:'5 places costed',conf:'med',verified:true,note:'Hand-costed = mean of the five hand-costed places listed below (his real lifestyle, ex-insurance); Comfort = guide estimate. Manila higher, provinces lower.'},
    places:[
      {name:'Cebu',sub:'pool+gym 1BR condo',f:835,conf:'med',verified:true,pool:true,note:'Regular 1BR condo, WITH pool+gym (Jul 2026 — Chiang Mai + Cebu keep pool+gym). Mainland beef supply, ~15min out. Rent repriced Jul 2026 from Airbnb monthly rates: ~€280 even Dec–Jan high season (was €370); 6-mo/yearly contracts likely lower. Line items re-examined Jul 2026 (Joël): groceries €110→€70, protein €63→€50, transport €80→€90, misc €95→€75 → ex-ins €898→€835. Priciest PH place.'},
      {name:'Siquijor',sub:'lean beach island',f:765,conf:'med',verified:true,note:'Home/café wifi covers the build phase — Eden Starlink coworking is a fixed install, not brought home, so no longer costed; no pool/gym; beef stocked on Dumaguete ferry runs. Rent repriced Jul 2026 (Airbnb scan) €240→€300 — thin island market, contracts likely lower.'},
      {name:'Valencia / Dumaguete',sub:'lean, mainland-priced',f:784,conf:'med',verified:true,note:'Cheapest PH place — real supermarkets, mainland beef ~€7/kg, no coworking premium, BI office in town for visa extensions. Rent repriced UP again Jul 2026 (Airbnb scan) → €360 (was €320; the original €260 lean estimate was too optimistic); contracts likely lower.'},
      {name:'Iloilo City',sub:'real mid-sized city',f:735,conf:'low',verified:true,note:'Real mid-sized regional city (~460k) — strongest everyday food/culture in PH (batchoy, Dinagyang), very safe, Ilonggo + English widely spoken. ⚠ Coastal city, NOT a beach town: the in-city Arevalo/Villa strip is modest, real beaches need a short Guimaras ferry. Rent set to €280/mo (Joël, Jul 2026 — revised down from €300; the €230 aggregator estimate was low), within the repriced PH lean-condo range (Siquijor/Valencia €300–360), contracts likely lower. Groceries re-examined €100→€70 (Jul 2026) → ex-ins €785→€735. Airbnb monthly → internet €0 + utilities aircon residual. Fish-forward (bangus/pelagics), beef from Panay pricier.'},
      {name:'Roxas City',sub:'Seafood Capital, small city',f:603,conf:'low',verified:true,beefMix:true,note:'Cheapest costed PH place. Small regional city on Panay (~180k), the "Seafood Capital of the Philippines" — fresh fish + pork/chicken very cheap (◆ beef not the staple), cooked seed-oil-free; Baybay Beach in town. Rent €250/mo aggregator estimate (conf Low — his Airbnb scans ran higher for Valencia/Siquijor, so treat as a floor). Groceries re-examined €90→€70 (Jul 2026) → ex-ins €623→€603. Airbnb monthly → internet €0 + utilities aircon residual.'}],
  ...
  {cc:'GE',n:'Georgia',f:'🇬🇪',roles:['anchor','live'],stamp:'2026-07-16',visa:0,maxstay:'365 days per entry; near-indefinite via a cheap annual border hop',
  ...
  {cc:'TH',n:'Thailand',f:'🇹🇭',roles:['anchor','live'],stamp:'2026-07-19',visa:26,maxstay:'90 days visa-exempt; 360 days/entry and up to 5 years on the DTV (tourist border-runs curbed since Nov 2025)',
    col:{f:838,n:1400,city:'Chiang Mai',conf:'med',verified:true,note:'Hand-costed = line-by-line (his real lifestyle, ex-insurance) — supersedes the old €800 lived anchor · Comfort = guide estimate · Bangkok +15–20% · re-confirm on next stay. 🆕 REPRICED Jul 31 2026 (€921→€838): switched to a condo building WITH an on-site resident CO-WORKING room, which cuts rent AND the café line together.'},
    places:[
      {name:'Chiang Mai',sub:'his anchor city · condo + coworking',f:838,verified:true,pool:true,note:'The representative cheap-TH base (his lived anchor, now hand-costed). ★ Pool+gym base (with Cebu). 🆕 HOUSING BASIS CHANGED Jul 31 2026: a Sansiri dcondo-type building with a resident CO-WORKING room (dcondo Sign / D Condo Ping / Dcondo Rin — Suthep & Fa Ham), €118–261 observed, €260 taken conservatively. Rent 290→260, utilities 55→40, internet 18→0 (building wifi), daytime food 180→160. ⚠ CO-LIVING PROPER FAILS HERE: it is a premium nomad product (€470–750) ABOVE a plain condo — the saving comes from swapping BUILDING, not product. ⚠ Kitchenette only (induction hob, no oven, LPG banned) — 330g/day workable but screen the unit. ⚠ Jan–Apr smog season is a real cost, unpriced. The two islands below are pricier lifestyle alternatives.'},
  ...
  {cc:'CZ',n:'Czechia',f:'🇨🇿',roles:['anchor','live'],stamp:'2026-07-16',visa:0,maxstay:'Unlimited — EU freedom of movement',
  ...
  {cc:'VN',n:'Vietnam',f:'🇻🇳',roles:['live'],stamp:'2026-07-19',visa:7,maxstay:'90 days per e-visa; 6–12 months+ sustainable via resets before scrutiny',
    col:{f:844,n:1100,city:'Da Nang',conf:'med',verified:true,note:'Hand-costed = line-by-line (his real lifestyle, ex-insurance); regular 1BR condo, NO pool+gym (Jul 2026 — only Chiang Mai + Cebu have pool+gym) · rent repriced Jul 2026 from Airbnb monthly rates: ~€270 even Dec–Jan high season (was €360); contracts likely lower · Comfort = guide estimate'},
  ...
  {cc:'KH',n:'Cambodia',f:'🇰🇭',roles:['live'],stamp:'2026-07-16',visa:28,maxstay:'Indefinite — rolling annual E-class extension, no border runs',
  ...
  {cc:'ID',n:'Indonesia',f:'🇮🇩',roles:['live'],stamp:'2026-07-20',visa:28,maxstay:'180 days, then you must leave',
    col:{f:721,n:1075,city:'5 places costed',conf:'med',verified:true,note:'Hand-costed = mean of the 5 hand-costed places below (his real lifestyle, ex-insurance; long-term-local rents, no pool+gym). Diet-geography by religion: Hindu Bali (Ubud, Sanur, Amed, Lovina) = pork/chicken/fish, imported beef dear; Batak Christian Lake Toba (Tuk Tuk) = beef/buffalo + ultra-cheap lake fish, his ruminant staple back. Tuk Tuk €572 = cheapest costed line in the whole app; Sanur €858 = priciest ID line (mature beach town — full fibre + Denpasar airport on the doorstep). Internet lines trimmed Jul 2026: the first ~2yr is building the business (uploading/writing/research), not HD calls, and Airbnb rents include wifi → no Starlink/call-grade premium costed (Tuk Tuk keeps a €30 4G buffer; the rest €0). If a serious call comes up, scope a venue on the ground. Comfort = a roomier estimate.'},
    places:[
      {name:'Tuk Tuk (Lake Toba)',sub:'cheapest costed · Batak Christian',f:572,conf:'med',verified:true,note:'CHEAPEST costed line in the whole app. Sumatra highland lake island; Batak CHRISTIAN → beef/buffalo + ultra-cheap lake fish (~€1.3/kg) free & cheap = his ruminant staple back, cheaper than the India goat mixes. Wifi: no fibre (Telkomsel 4G/Orbit marginal) → internet costed at a €30 mobile-data buffer (down from €75 — no Starlink/call-grade premium in the build phase); TEST the room first. Rent €200 long-term (guesthouse-grade; thin market, Airbnb overstates — negotiate on the ground). Remote exit via Medan + ferry.'},
      {name:'Amed',sub:'cheapest Bali coast · Hindu',f:674,conf:'med',verified:true,beefMix:true,note:'Cheapest Bali coast — remote NE freedive/fishing village; Hindu → pork/chicken/fish, FISH-forward (fishing village). Wifi: village ~8Mbps → Telkomsel 4G primary (fine for the build phase; no Starlink/call-grade premium costed). Lean negotiated rent ~€250 (thin market); few cafes → low daytime spend.'},
      {name:'Lovina (North Bali)',sub:'budget-quiet north coast · Hindu',f:708,conf:'med',verified:true,beefMix:true,note:'Budget-quiet north coast (Buleleng); Hindu → pork/chicken/fish, FISH-forward (fishing coast). Cheaper than Ubud/Sanur. ⚠ WIFI mild risk: no guaranteed fibre town, but Lovina 4G is solid (35–60Mbps, fine for Zoom) + Biznet reaches parts of town → 4G primary (internet costed €0 — no call-grade premium in the build phase); verify the house line. ⚠ ~2.5–3h to Ngurah Rai airport → costlier visa-exits (€58). Rent €300 (Airbnb-confirmed; simple studio ~€250 floor).'},
      {name:'Ubud',sub:'wellness/coworking hub · Hindu',f:794,conf:'med',verified:true,beefMix:true,note:'Bali wellness/coworking hub; Hindu → pork/chicken/fish. Its edge = Biznet fibre, video-grade wifi. Premium cafe-work scene = the main cost dial. Rent ~€300 (his own Airbnb search; villa oversupply, offline stock).'},
      {name:'Sanur',sub:'mature beach town · Hindu',f:858,conf:'med',verified:true,beefMix:true,note:'Priciest ID line. Flat, walkable SE-coast retiree/family town; Hindu → pork/chicken/fish. Its edge = full Biznet/IndiHome fibre (video-grade, no Starlink) + Denpasar airport on the doorstep (easiest visa-exits of any ID place). Rent €400 (mature market, less oversupply than Ubud → pricier; cheapest homestay ~€260 floor). Groceries/eating-out cheaper than Ubud.'}],
  ...
  {cc:'IN',n:'India',f:'🇮🇳',roles:['live'],stamp:'2026-07-19',visa:12,maxstay:'90 days/entry; stay under 182 days/financial-year (tax hard-avoid) — ~176 days practical max',
    col:{f:781,n:1100,city:'6 places costed',conf:'med',verified:true,note:'Hand-costed = mean of the 6 hand-costed places below (his real lifestyle, ex-insurance; lean studio, no pool+gym; protein = goat-forward local mix — beef banned). Bimodal range: inland spiritual towns €652–710 = his CHEAPEST tier ever costed; Goa/Kerala beach €858–908 = mid-tier. Comfort = a roomier estimate.'},
    places:[
      ...
      {name:'Assagao',sub:'best wifi (priciest)',f:908,conf:'med',verified:true,beefMix:true,note:'Leafy N-Goa: best wifi ~95Mbps + NomadGao coworking + best meat/fish sourcing, ride to Arambol/beaches. No beachfront; priciest India node. Rent repriced Jul 2026 from Airbnb monthly rates: ~€320 even Dec–Jan high season (was €360).'}],
  ...
  {cc:'MY',n:'Malaysia',f:'🇲🇾',roles:['live'],stamp:'2026-07-19',visa:5,maxstay:'90 days visa-free; ~9–12 months via ~3 resets before scrutiny',
    col:{f:835,n:1300,city:'Penang',conf:'med',verified:true,note:'Hand-costed = line-by-line for Penang (his real lifestyle, ex-insurance) · Comfort = guide estimate (KL) · best infrastructure-per-euro in SE Asia. 🆕 REPRICED Jul 31 2026 (€955→€835) — HOUSING BASIS IS NOW CO-LIVING, not a 1BR condo: a private room all-in with utilities, wifi, workspace and a full kitchen included (George Town Collective ≈€250; €300 taken conservatively). Rent 360→300, utilities 20→0, daytime food 190→150. ⚠ The old €360 1BR assumed a 12-month lease he will not sign, plus a 3.5-month deposit stack (~€1,260); co-living takes 1-month stays. ⚠ Penang condos have NO resident coworking, so a solo condo ALSO needs RM300–500/mo of separate coworking — co-living genuinely undercuts a 1BR here, the OPPOSITE of Chiang Mai. ✅ Kitchens are real (better than Thailand) and there is no smog season.'},
  ...
  {cc:'SI',n:'Slovenia',f:'🇸🇮',roles:['live'],stamp:'2026-07-14',visa:0,maxstay:'Unlimited — EU freedom of movement',
  ...
  {cc:'JP',n:'Japan',f:'🇯🇵',roles:['live'],stamp:'2026-07-20',visa:0,maxstay:'90-day blocks only (hard cap); ~180 days/year realistic ceiling',
    col:{f:968,n:1900,city:'2 places costed',conf:'med',verified:true,note:'Hand-costed = mean of the 2 places below (his real lifestyle, ex-insurance). 🆕 BASIS CORRECTION Jul 31 2026 — NOT A REPRICE (JP €1,268→€968): the old €500–600 furnished-monthly/1LDK was never a product he could rent for repeated 90-day blocks — no residence card, no jūminhyō, no guarantor, key money and 2-year terms. A SHARE HOUSE is the only category available on a tourist stamp, so housing is now ONE all-in line at €300 (rent + utilities + wifi), against €165–197 actually verified. ⚠ Stock at that price is metro COMMUTER BELT (Noda, Suita, Higashi-Osaka, Yokohama), NOT city core. ⚠ At this basis Osaka and Fukuoka CONVERGE (€965 vs €970) — the old €105 gap was entirely rent, so the choice between them is no longer financial. 🚨 JAPAN IS NOW GATED BY THE 90-DAY VISA CAP, NOT BY PRICE. Comfort = a +~30% band, ESTIMATE · Tokyo higher again.'},
    places:[
      {name:'Osaka',sub:'Kansai hub · share-house block',f:965,conf:'med',verified:true,note:'Kansai 90-day block. Central Kansai (Kyoto/Nara/Kobe day-trips), KIX hub, flat/bikeable → transport €55. Discount-supermarket + cheap-eats scene holds food level (groceries €150, daytime €150). Protein = JP beef mince ~¥2,000/kg (not ◆). 🆕 HOUSING = SHARE HOUSE all-in €300, 3-month contract. VERIFIED STOCK: THE SHARE Kashiwa Kita (Noda, Chiba) €184–197 effective over 3mo — co-working space, 68 rooms/6 kitchens, in-room fridge, 75.8% Japanese residents, 3-month minimum; sister house THE ROOF €165–197; Urban Terrace Green Park (Suita, Osaka) €351 with a web-conference work lounge + gym. ⚠ THE FEE TRAP: a ¥30–50k one-off contract/cleaning fee is a 30–50% short-stay tax over 3 months — compare TOTAL 3-month outlay, never the advertised rent (one "no deposit" listing was the dearest on the board). ⚠ "International share house" branding is a NEGATIVE signal for Japanese practice — those houses run ~50% foreign. ⚠ Daytime food deliberately NOT cut again: already reduced €320→€150 in the Jul-19 recalibration. ⚠ euro figure is a weak-yen bet.'},
      {name:'Fukuoka',sub:'calmer · closest to Asia',f:970,conf:'med',verified:true,note:'Calmer than Osaka + marginally cheaper food + closest to Asia for the cheap 90-day exit-flights (Seoul/SE Asia). Food lines from his own Jul-2026 tuning: groceries €150, daytime €150, protein €110. 🆕 HOUSING = SHARE HOUSE all-in €300 (was €600 rent + €50 utilities), 3-month contract — see the Japan card and Osaka note for why this is a BASIS CORRECTION rather than a reprice. ⚠ Only €5 above Osaka now (transport €60 vs €55): the two cities have converged, so pick on what you want nearby, not on cost.'}],
    fx:'HIGH — the euro case is a weak-yen bet; if EUR/JPY strengthens 20%, Hand-costed Fukuoka rises to ~€1,210 (was ~€1,630 on the old 1LDK basis). Spot ≈185.5 Jul 2026, range-bound 184–186.',
  ...
  {cc:'NP',n:'Nepal',f:'🇳🇵',roles:['live'],stamp:'2026-08-07',visa:38,maxstay:'🚨 150 days per CALENDAR YEAR, aggregate across all entries — resets 1 Jan. NOT a per-entry cap.',
    blocks:'150 days/calendar year',
    col:{f:667,n:1000,city:'2 places costed',conf:'med',verified:true,note:'Hand-costed = mean of the 2 places below (his real lifestyle, ex-insurance). ⚠ KATHMANDU IS ONE LOCATION ON PURPOSE: Boudha, Patan/Jhamsikhel, Budhanilkantha and Pharping are ALL Kathmandu District, and of the 11 lines only HOUSING differed for a real reason (Boudha has a short-stay furnished guesthouse market; Patan’s cheap tier is annual leases with 2–3 months deposit) — the grocery/protein/gym/café spreads were estimation artefacts for the same city. Housing set by Joël: Kathmandu €230, Pokhara €210 (his Airbnb monthly scan). ⭐ BUFFALO is the everyday cheap red meat (Tibetan/Newar meat culture), so unlike India his ruminant preference is served, not compromised — no non-beef mix needed. 🚨 THE €/MONTH FIGURE COVERS FIVE MONTHS ONLY: the 150-day cap means ~215 days/yr are spent elsewhere and are priced in NO line here. ⚠ AND READ THE RANKING WITH CARE: Nepal shows as the cheapest live country here partly because TWO LINES ARE UNDER-SOURCED — Misc €21 (household sundries unpriced; peer rows carry €55–90 with fun+household in) and Local travel €16–33 (one mandatory exit only, vs €50–90 elsewhere). Raise Misc toward €55 and the gap to Indonesia nearly closes. Comfort = a roomier band, ESTIMATE.'},
    places:[
      {name:'Kathmandu',sub:'the whole valley as ONE location',f:697,conf:'med',verified:true,note:'Boudha + Patan/Jhamsikhel + Budhanilkantha + Pharping merged — all Kathmandu District. HOUSING BASIS: furnished monthly guesthouse/studio (the Boudha market runs NPR 14,000–25,000/mo WITH kitchen, gas and utilities included — RYI’s own 2024 directory, ~59 listings essentially all a 1–17 min walk to the stupa). Boudha is the reason to be in Nepal at all: Rangjung Yeshe Institute teaches Buddhist philosophy in English and is open to lay foreigners year-round. 💡 THE BIG LEVER: the €262 daytime-café line is the LARGEST item in the row, while Kathmandu coworking desks run €23–58/mo (Work Around · Platform Inc · Innovation Hive · Hub108) — NOT deducted, because no on-premises workspace was verified. ⚠ Winter air: valley PM2.5 peaks in January (~103 µg/m³ on the 2019 profile) and is cleanest in August (~12) — be elsewhere Dec–Mar. Medical is the country’s best (CIWEC, Norvic, Grande, B&B, Patan).'},
      {name:'Pokhara',sub:'Lakeside · outside the valley bowl',f:636,conf:'med',verified:true,note:'Lakeside/Baidam — walkable and self-contained, and the ONLY costed place outside greater Kathmandu. HOUSING BASIS: Airbnb monthly apartment at €210 (his own scan — materially below every desk comparator; rooms go cheaper still). Cheaper than Kathmandu on housing, café and protein; DEARER on the exit flight (€33 vs €16) because PKR has far thinner international connectivity than KTM — a real location difference, not an artefact. ⚠ Pokhara’s annual PM2.5 is NOT published — do not assume it beats Kathmandu: on 12 Feb 2025 it hit AQI 187, WORSE than Kathmandu’s 161, in forest-fire season (Mar–Apr). Medical: Manipal Teaching Hospital (750 beds). Practice: Dhamma Pokhara (Goenka, dana-only) + Ganden Yiga Chozin (English-taught, terms unverified).'}],
    stay:'🚨 150 tourist days per CALENDAR YEAR, aggregate — not per entry, and it resets 1 Jan, so a stay straddling 31 Dec draws on two allowances. VOA 15d $30 / 30d $50 / 90d $125, all multi-entry; extensions $3/day with a 15-day minimum ($45); overstay $5/day. Using the full 150 days = $305 ≈ €57 per month-in-country; the €38 headline is the short-stay (3-month stint) convention used for pass-through live-countries. ⚠ RETRACTED: there is NO gratis Nepal visa for a Dutch passport — the free tiers are under-10s, FIRST-VISIT SAARC nationals for 30 DAYS ONLY, Chinese nationals and NRN cardholders. The only route past 150 days is a study visa ($30/mo via RYI, needs ≥9 credits/semester) — and RYI’s own page confirms its cheap Non-Credit Study route does NOT qualify.',
    work:'Coaching performed while IN Nepal is Nepal-source in principle, but under the 150-day cap he cannot reach the 183-day residency limb. ⚠ The abode limb has no day threshold — don’t establish a settled base. Perform and bill offshore where possible.',
    res:'⚠ Residency has THREE independent limbs (Income Tax Act 2058 §2(ao)): 183+ days in a 365-day period; government deputation; and a “NORMAL PLACE OF ABODE” test with NO DAY THRESHOLD, turning on where major economic activity sits. 150 < 183 keeps the day-count limb safe — the abode limb does not care about days, so a long lease plus a centre of life could still bite.',
    avoid:'⚠ RESIDENCY = NEVER AN OFF-RAMP — and for a different reason than India. There is NO Netherlands–Nepal double tax treaty (Nepal has 11 DTAAs; NL is not among them), so if both countries deem you resident there is NO tie-breaker at all. And crypto trading, holding and mining are comprehensively ILLEGAL in Nepal (NRB notices 2017, reaffirmed 2021, enforced via the Foreign Exchange Regulation Act — fines of 1–3× the transacted amount and up to 3 years imprisonment), while a Nepali tax resident is still taxed on worldwide income including foreign crypto gains. Experience row only — never a sale venue, never an anchor.',
    note:'Nepal is a TWO-CITY COUNTRY BY INFRASTRUCTURE, not by geography or charm — ~30 other places were screened (hill towns, east, west, Terai, every non-valley practice site) and monthly rental markets, real hospitals, fibre and any English-legible long-stay scene exist essentially only in Kathmandu and Pokhara. Nearest others: Dhulikhel (Kavre, €145–291, a serious teaching hospital — but a Kathmandu commuter town) and Chitwan/Bharatpur (€113–235, unlivable ~3 months/yr). Pharping and Budhanilkantha are deliberately NOT costed here — no monthly rental market, no confirmed kitchens, no meat market, no gym; they are practice destinations inside a trip, on the sadhana ledger. Full detail: research/research-16-nepal-5-places.md.'},
...
const PATH=[
  {id:'prep',name:'Prepare',when:'now → 2027 · in NL',steps:[
    ...
    {id:'p7',t:'Skip term deposits — iBonds replaced them',dep:'Research-5: fixed-maturity iBonds ETFs beat Raisin deposits on yield, liquidity AND residency. Nothing residence-tied should hold the pot.'},
  ...
  {id:'exit',name:'Exit',when:'2027 · before the 2028 pivot',steps:[
    {id:'x1',t:'Sell apartment + company (≈ €310k net)',dep:'Selling the apartment is ALSO the tax shield: no available Dutch dwelling = the decisive clean-exit factor (decision-tree Q1).'},
    {id:'x2',t:'Park the ≈€310k in the chosen blend at IBKR/Swissquote',dep:'Position BEFORE deregistering — full product access needs a residence.'},
    ...
    {id:'x5',t:'Deregister from NL — cleanly, and DOCUMENT it',dep:'Before 1 Jan 2028 — the Wet werkelijk rendement box 3 is NOT yet law (Eerste Kamer vote postponed 30 Jun 2026; novelle due 15 Sep 2026), but the intended start is still 1 Jan 2028 and the direction of travel is one-way, so the deadline stands. ⚠ The stronger reason to be gone is the END STATE both the cabinet and the Senate want — a full vermogenswinstbelasting, whose art. 5.37 template already deems a disposal on emigration. See the Agenda. Guardrail 1, the master shield: BRP uitschrijving + no available Dutch dwelling + NL accounts closed + center of life gone. Keep every piece of paperwork — a sloppy exit is the one failure mode that survives departure. ⚠ The 12-month boomerang clock starts HERE: re-settling in NL within 12 months of departure = deemed NL-resident the whole time (art. 2.2 — see Playbooks).'}]},
...
const PLAYBOOKS=[
  ...
  {id:'crash',icon:'▼',accent:'warn',title:'Crash — deploy the powder, hold the core',sub:'the ≈€90k sleeve exists for exactly this',body:[
    ...
    {h:'Deploying the ≈€90k',p:'Powder sleeve (MMF/FRN + govt) sells any weekday, cash in 2–4 business days, from anywhere via IBKR. His structure: this is the slice earmarked to buy cheap stocks/BTC at a bottom — the apartment core stays untouched.'},
    ...
    {h:'Second-line powder — borrow against the core',p:'The iBonds core is marginable collateral at IBKR: for a generational bottom, a margin loan of ≤40% of the core’s value (≈€90k more) can be drawn WITHOUT selling anything — the loan repays itself as rungs mature at par. Strict rules: only AFTER the cash sleeve is spent; deploy on a predefined trigger, not on calling “the bottom” (at ≤40% vs 2y IG, a further −30% leg cannot force a call); pair the draw with a voluntary de-lever line (broker raises bond haircuts → trim and repay on YOUR terms before the liquidation algo does); never draw in the same month as an IBKR residency-country switch. Verify at the time: the ETFs’ marginability + house maintenance + EUR margin rate (floats, ≈benchmark +1.5%, usually ABOVE the bond yield — the drawn tranche carries ≈flat).'},
