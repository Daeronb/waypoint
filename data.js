...
const MONITORS=[
  ...
  {prinsjesdag:true,t:'Prinsjesdag — NL exit-tax / inwonerschapsfictie check',
    d:'⚖ THE BILL LANDED AND PASSED — box 3 is settled law since 7 Jul 2026 (see the 1 Jan 2028 row), so this row is no longer watching for THAT. Prinsjesdag 2026 = 15 Sep. What still matters in the package: (a) the koninklijk besluit fixing the WWR start date — only a slip LATER is possible, and that is slack; (b) any Belastingplan-2027 amendment reopening the WWR (the promised softening letter, rates, thresholds); (c) THE EMIGRANT EXIT-TAX EXPLORATION — the one thing here that could still bite a mid-2027 departure, and the reason the fast path (≈3.5 months to entry into force, Playbooks monitor card) still matters; (d) the inwonerschapsfictie motion. Every September until departure.'},
  {due:'2027-12-31',t:'Hard deadline — NL deregistration complete before 1 Jan 2028',
    d:'⚖ NO LONGER AN ASSUMPTION — ENACTED. The Wet werkelijk rendement box 3 (36748) passed the Tweede Kamer 12 Feb 2026 and the EERSTE KAMER on 7 Jul 2026. Entry into force is set by koninklijk besluit, intended 1 Jan 2028 — a KB date can slip LATER but never earlier, so planning to 1 Jan 2028 stays the conservative line and a slip would be slack, not risk. VERMOGENSAANWAS (annual tax on UNREALISED gains) is the MAIN RULE; only real estate and startup shares stay on realisation — so a crypto position gets taxed on paper gains every year it is held. Flat 36%, heffingvrij resultaat €1.800, losses carry FORWARD only (the carry-back was dropped). ✅ The act contains NO emigration exit-charge — a clean departure still ends the claim, which is what Guardrail 1 buys. Target departure mid-2027 leaves ~6 months of slack. Path x5 is the master-shield checklist; the AOW 1-year window opens the day this happens. Verified 27 Jul 2026.'},
  ...
  {t:'TH remittance decree — monitor, never plan on it',
    d:'✅ RE-VERIFIED 27 Jul 2026 — STILL NOT ENACTED, no change to the leash. The relaxation (exempt if remitted in the year earned or the next) remains a DRAFT; the instrument would be a royal decree or ministerial regulation and it never cleared Cabinet/Council of State, having been shelved around the Dec 2025 dissolution + Feb 2026 election. The operative law is still the Jan-2024 remittance rule (Por.161/2566); income earned BEFORE 1 Jan 2024 stays permanently exempt on remittance (Por.162/2566). Until published law the no-remit leash is permanent; if enacted it also zeroes the ~3.5% tax on living remittances. Same check: the DORMANT Sep 2024 worldwide-income draft (never reached parliament) — a revival would make TH-resident SALE years dangerous. Re-verify both before committing to TH residency and again before any sale.'},
...
const BLENDS=[
  ...
  {id:'target3',name:'Early home',sub:'DUAL-DESTINATION powder: €100k powder + €133k iBonds-2030 ≈ €234k in 2027 euros (≈flat in nominal terms while you live off the yield) — pointable at an NL home at ANY early-return date (early-exit ≈ −1–3% worst case, €0 from Jan 2031), or left invested as crash powder + apartment tranche if plans hold. ⚠ A €250k home in TODAY’S euros costs ≈€286k by Jan-2031 at 3%/yr, so the tranche lands ≈€50k short — see the iBonds-2030 slice. The €116k iBonds-2031 lock rides to maturity untouched either way.',
    ...
    why:{
      ...
      ib30:'The home-completion tranche. Cashes out Jan 2031; with the powder ≈ €234k — but that figure is in 2027 euros and stays FLAT, because you spend the yield rather than reinvest it. The target does not: a €250k home in today’s euros costs ≈€269k by Jan-2029, ≈€277k by Jan-2030, ≈€286k by Jan-2031 at 3%/yr housing. Closing the ≈€35–51k gap = shifting that much iBonds-2031 → here, at ≈€7–11/mo of forgone yield (3.57 vs 3.32) — a documented dial, deliberately NOT baked in. Otherwise top up from the lock at sale: by Jan-2031 its duration is ≈1, so even a 2% rate shock costs ≈€560.',
