...
const COUNTRIES=[
  {cc:'PH',n:'Philippines',f:'🇵🇭',roles:['anchor','live'],stamp:'2026-07-19',primary:true,visa:40,maxstay:'36 months continuous — no border runs needed',
    col:{f:808,n:1250,city:'4 places costed',conf:'med',verified:true,note:'Hand-costed = mean of the four hand-costed places listed below (his real lifestyle, ex-insurance); Comfort = guide estimate. Manila higher, provinces lower.'},
    places:[
      {name:'Cebu',sub:'pool+gym 1BR condo',f:898,conf:'med',verified:true,pool:true,note:'Regular 1BR condo, WITH pool+gym (Jul 2026 — Chiang Mai + Cebu keep pool+gym). Mainland beef supply, ~15min out. Rent repriced Jul 2026 from Airbnb monthly rates: ~€280 even Dec–Jan high season (was €370); 6-mo/yearly contracts likely lower. Priciest PH place.'},
      ...
      {name:'Iloilo City',sub:'real mid-sized city',f:785,conf:'low',verified:true,note:'Real mid-sized regional city (~460k) — strongest everyday food/culture in PH (batchoy, Dinagyang), very safe, Ilonggo + English widely spoken. ⚠ Coastal city, NOT a beach town: the in-city Arevalo/Villa strip is modest, real beaches need a short Guimaras ferry. Rent set to €300/mo (Joël, Jul 2026) — the €230 aggregator estimate was low; aligns with the repriced PH lean-condo range (Siquijor/Valencia €300–360), contracts likely lower. Airbnb monthly → internet €0 + utilities aircon residual. Fish-forward (bangus/pelagics), beef from Panay pricier.'}],
