...
const COUNTRIES=[
  ...
  {cc:'ID',n:'Indonesia',f:'🇮🇩',roles:['live'],stamp:'2026-07-19',
    col:{f:724,n:1075,city:'3 places costed',conf:'med',verified:true,note:'Hand-costed = mean of the 3 hand-costed places below (his real lifestyle, ex-insurance; long-term-local rents, no pool+gym). Diet-geography by religion: Hindu Bali (Ubud + Amed) = pork/chicken/fish, imported beef dear; Batak Christian Lake Toba (Tuk Tuk) = beef/buffalo + ultra-cheap lake fish, his ruminant staple back. Tuk Tuk €617 = cheapest costed line in the whole app. ⚠ Wifi is make-or-break in Amed + Tuk Tuk (village/highland — Starlink advised, costed into Tuk Tuk); Ubud fibre is video-grade. Comfort = a roomier estimate.'},
    places:[
      {name:'Tuk Tuk (Lake Toba)',sub:'cheapest costed · Batak Christian',f:617,conf:'med',verified:true,note:'CHEAPEST costed line in the whole app. Sumatra highland lake island; Batak CHRISTIAN → beef/buffalo + ultra-cheap lake fish (~€1.3/kg) free & cheap = his ruminant staple back, cheaper than the India goat mixes. ⚠ WIFI MAKE-OR-BREAK: no fibre (Telkomsel 4G/Orbit marginal) → internet costed at €75 including Starlink (~€43) for daily video calls; TEST the room first. Rent €200 long-term (guesthouse-grade; thin market, Airbnb overstates — negotiate on the ground). Remote exit via Medan + ferry.'},
      {name:'Amed',sub:'cheapest Bali coast · Hindu',f:727,conf:'med',verified:true,beefMix:true,note:'Cheapest Bali coast — remote NE freedive/fishing village; Hindu → pork/chicken/fish, FISH-forward (fishing village). ⚠ WIFI RISK: village ~8Mbps → Telkomsel 4G primary + Starlink (~€43) advised. Lean negotiated rent ~€250 (thin market); few cafes → low daytime spend.'},
      {name:'Ubud',sub:'wellness/coworking hub · Hindu',f:827,conf:'med',verified:true,beefMix:true,note:'Bali wellness/coworking hub; Hindu → pork/chicken/fish. Its edge = Biznet fibre, video-grade wifi. Premium cafe-work scene = the main cost dial. Rent ~€300 (his own Airbnb search; villa oversupply, offline stock).'}],
